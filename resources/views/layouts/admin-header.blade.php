    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">  
            <div class="logo-wrapper"> <a href="index.html">
              Tinmory
              <!-- <img class="img-fluid for-light" src="{{asset('admin/assets/images/logo/logo_dark.png')}}" alt="logo-light"><img class="img-fluid for-dark" src="{{asset('admin/assets/images/logo/logo.png')}}" alt="logo-dark"> -->
            </a></div>
          ...
          <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
              <div class="d-flex align-items-center gap-2 ">
                <h4 class="f-w-600">Welcome Admin</h4><img class="mt-0" src="{{asset('admin/assets/images/hand.gif')}}" alt="hand-gif">
              </div>
            </div>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" data-layout="stroke-svg">
          <div class="logo-wrapper"><a href="index.html" style="color: #fff !important;font-size: 25px !important;font-weight: bold !important;">
            Tinmory
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    ...
                    </svg><span class="lan-6">CMS</span></a>
                  <ul class="sidebar-submenu">
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="contacts.html">
                    ...
                    </svg><span>Contact Submissios</span></a></li>
        ...
        if(countryID) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#warehouse_city').empty().append('<option value="0">--Select--</option>'); // Clear cities
                    $.each(data, function(key, value) {
